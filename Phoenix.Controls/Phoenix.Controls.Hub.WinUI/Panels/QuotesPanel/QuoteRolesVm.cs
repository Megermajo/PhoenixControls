...
/// <summary>
/// Wraps a <see cref="QuoteRoles"/> checkmark set as six two-way <c>bool?</c>
/// properties so a settings row can render the exact SIX checkboxes the model calls
...
/// save through <c>_changed</c>. Mirrors CounterRolesVm exactly.
/// </summary>
public sealed class QuoteRolesVm : ObservableObject
{
    private readonly QuoteRoles _roles;
    private readonly Action _changed;

    public QuoteRolesVm(QuoteRoles roles, Action changed)
    {
        _roles = roles ?? new QuoteRoles();

...
/// <summary>
/// Wraps a <see cref="PollRoles"/> checkmark set as six two-way <c>bool?</c> properties so
...
/// <c>_changed</c>. Mirrors SongRolesVm / QuoteRolesVm exactly.
///
...
/// </summary>
public sealed class PollRolesVm : ObservableObject
{
    private readonly PollRoles _roles;
    private readonly Action _changed;

    public PollRolesVm(PollRoles roles, Action changed)
    {
        _roles = roles ?? new PollRoles();
